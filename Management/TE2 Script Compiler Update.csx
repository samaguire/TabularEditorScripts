...
json["ScriptCompilerDirectoryPath"] = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + @"\.nuget\packages\microsoft.net.compilers.toolset\4.4.0\tasks\net472";
